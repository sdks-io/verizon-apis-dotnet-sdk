...
namespace VerizonThingSpaceQualityOfServiceAPIEndpoints.Tests
{
    ...
    public class ControllerTestBase
    {
        ...
        /// <summary>
        /// Gets VerizonThingSpaceQualityOfServiceAPIEndpointsClient Client.
        /// </summary>
        protected VerizonThingSpaceQualityOfServiceAPIEndpointsClient Client { get; private set; }
        ...
        public void SetUp()
        {
            VerizonThingSpaceQualityOfServiceAPIEndpointsClient config = VerizonThingSpaceQualityOfServiceAPIEndpointsClient.CreateFromEnvironment();
