...
namespace Verizon.Standard.Authentication
{
    ...
    public sealed class VZM2mTokenModel
    {
        ...
        internal static VZM2mTokenModel FromOptions(VZM2MTokenModelOptions options)
        {
            var builder = new Builder(options.VZM2mToken);
            return builder.Build();
        }
    }

    public class VZM2MTokenModelOptions
    {
