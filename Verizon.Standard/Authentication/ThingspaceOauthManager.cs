...
namespace Verizon.Standard.Authentication
{
    ...
    public class ThingspaceOauthManager : AuthManager, IThingspaceOauthCredentials
    {
        ...
        {
            var token = await getOAuthController().RequestTokenThingspaceOauthAsync(BuildBasicAuthHeader(), fieldParameters: additionalParameters).ConfigureAwait(false);
    ...
    public sealed class ThingspaceOauthModel
    {
        ...
        internal static ThingspaceOauthModel FromOptions(ThingspaceOauthModelOptions options)
        {
    ...
    public class ThingspaceOauthModelOptions
    {
