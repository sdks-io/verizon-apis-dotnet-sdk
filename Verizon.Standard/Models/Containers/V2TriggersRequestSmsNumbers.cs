// <copyright file="V2TriggersRequestSmsNumbers.cs" company="APIMatic">
// Verizon.Standard
//
...
namespace Verizon.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<V2TriggersRequestSmsNumbers>),
        new[] {
    ...
    public abstract class V2TriggersRequestSmsNumbers
    {
        ...
        /// </summary>
        /// <returns>
        /// The V2TriggersRequestSmsNumbers instance, wrapping the provided Cellphonenumber value.
        /// </returns>
        ...
        private sealed class CellphonenumberCase : V2TriggersRequestSmsNumbers, ICaseValue<CellphonenumberCase, Cellphonenumber>
        {
