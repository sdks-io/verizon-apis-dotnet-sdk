// <copyright file="V2TriggersRequest1SmsNumbers.cs" company="APIMatic">
// Verizon.Standard
//
...
namespace Verizon.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<V2TriggersRequest1SmsNumbers>),
        new[] {
            typeof(CellphonenumberCase)
        },
        false
    )]
    public abstract class V2TriggersRequest1SmsNumbers
    {
        /// <summary>
        /// This is cellphonenumber case.
        /// </summary>
        /// <returns>
        /// The V2TriggersRequest1SmsNumbers instance, wrapping the provided Cellphonenumber value.
        /// </returns>
        public static V2TriggersRequest1SmsNumbers FromCellphonenumber(Cellphonenumber cellphonenumber)
        {
        ...
        private sealed class CellphonenumberCase : V2TriggersRequest1SmsNumbers, ICaseValue<CellphonenumberCase, Cellphonenumber>
        {
