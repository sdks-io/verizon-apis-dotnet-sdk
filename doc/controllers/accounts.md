...
try
{
    ApiResponse<AccountLeadsResult> result = await accountsController.ListAccountLeadsAsync(aname, null);
}
...
try
{
    ApiResponse<Account> result = await accountsController.GetAccountInformationAsync(aname);
}
catch (ApiException e)
{
    // TODO: Handle exception here
...
try
{
    ApiResponse<AccountStatesAndServices> result = await accountsController.ListAccountStatesAndServicesAsync(aname);
}
catch (ApiException e)
{
    // TODO: Handle exception here
