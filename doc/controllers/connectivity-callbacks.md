...
try
{
    ApiResponse<CallbackActionResult> result = await connectivityCallbacksController.RegisterCallbackAsync(
        aname,
        body
    );
}
...
try
{
    ApiResponse<CallbackActionResult> result = await connectivityCallbacksController.DeregisterCallbackAsync(
        aname,
        sname
    );
}
