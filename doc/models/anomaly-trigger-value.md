...
| `TriggerAttributes` | [`List<TriggerAttributesOptions2>`](../../doc/models/containers/trigger-attributes-options-2.md) | Optional | Additional details and keys for the trigger. |
